function addZombieEventCards(pushCard, helpers) {
  const pushTileClearCard = (name, description, buildLog) => {
    pushCard(name, description, (player) => {
      ...
      logLine(buildLog(player.name, removed));
    });
  };

  pushTileClearCard("Grenade", "Remove all zombies on your tile",
    (name, removed) => `${name} played Grenade and removed ${removed} zombie(s) on this tile.`);
  ...
  pushTileClearCard("Molotov", "Remove all zombies on your tile",
    (name, removed) => `${name} played Molotov and burned ${removed} zombie(s) on this tile.`);
  ...
  pushTileClearCard("Where Did Everybody Go?", "Remove all zombies on your tile",
    (name, removed) => `${name} played Where Did Everybody Go? (${removed} zombie(s) removed).`);
